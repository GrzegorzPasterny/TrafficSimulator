...
namespace TrafficSimulator.Domain.Commons
{
	...
	{
		public static Error TrafficLightsOff(Guid id)
			=> Error.Failure("TrafficSimulator.LightsOff",
				$"Not possible to change Traffic Lights state when they are off [TrafficLightsId = {id}]");

		public static Error TrafficLightsAlreadyInRequestedState(Guid id, TrafficLightState trafficLightState)
		...
		public static Error TrafficLightsOverallState(Guid id, bool isOn)
